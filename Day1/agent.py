...
The agent combines an LLM + tools + loop.
"""
...
SYSTEM_PROMPT = (
    ...
    "Never guess private student information. "
    "Always use get_student_data when the question requires "
    "information about a student. "
    "Use calculator for arithmetic calculations. "
    "Available students are Anu, Bala, Charan, and Divya. "
...
def agent(question, max_steps=6, verbose=True):
    ...
    for step in range(1, max_steps + 1):
        ...
        # If the LLM gives a final answer
